...
export default function Home() {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-black">
      ...
      <div ref={gridContainer} className="relative w-fit h-fit">
        <motion.div
          className="hidden md:block absolute left-0 top-0 w-full h-full bg-[linear-gradient(to_right,rgba(184,65,65,0.31)_1px,transparent_1px),linear-gradient(to_top,rgba(184,65,65,0.31)_1px,transparent_1px)] md:bg-[size:80px_60px] bg-[size:50px_50px]"
          initial={{ y: -220, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true, amount: 0.4, root: gridContainer}}
          transition={{ duration: 0.3, ease: "easeIn" }}
        ></motion.div>
        <motion.div
          className="block md:hidden absolute left-0 top-0 w-full h-full bg-[linear-gradient(to_right,rgba(184,65,65,0.31)_1px,transparent_1px),linear-gradient(to_top,rgba(184,65,65,0.31)_1px,transparent_1px)] md:bg-[size:80px_60px] bg-[size:50px_50px]"
          initial={{ y: -320, opacity: 0 }}
          whileInView={{ y: 5, opacity: 1 }}
          viewport={{ once: true, amount: 0.2, root: gridContainer}}
          transition={{ duration: 0.6, ease: "easeOut" }}
        ></motion.div>
        <div className="w-full relative z-40 mt-8 flex justify-center">
        ...
        <div className="max-md:p-7 max-md:pt-10 max-md:pb-10 z-40 p-30 pt-10 grid [@media(max-width:880px)]:grid-cols-1 [@media(max-width:1180px)]:grid-cols-2 grid-cols-3 gap-3 auto-rows-fr transform ease-in duration-150">
          <Card
            Children={ListChecks}
      ...
      <div className="w-full h-[1px] z-40 bg-linear-to-r from-neutral-400 via-red-600 to-neutral-400 "></div>
      ...
      <div
        ref={buttonContainer}
        className="flex justify-center z-40 gap-5 md:gap-8 mt-5"
      >
        <motion.button
