...
export default function Home() {
  return (
    <div className="min-w-screen min-h-screen bg-black">
      ...
      <div className="absolute z-10 top-[68%] h-[370px] max-md:h-[350px] left-0 w-screen bg-linear-to-b from-transparent to-black"></div>
      ...
      <motion.div className="absolute z-40 top-0 left-0 w-full h-[67%] md:h-[72%] flex flex-col justify-end bg-transparent" initial={{y:20,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:0.5,ease:"easeInOut"}}>
        <Hero />
      </motion.div>
    </div>
  );
