...
export const Card = ({ Children, Paragraph, Heading }: Props) => {
  return (
    <div className="flex-1 group">
      <div className="h-full p-6 max-md:p-2 max-md:pt-4 rounded-lg border border-neutral-600 bg-neutral-800/50 md:bg-neutral-900/60 backdrop-blur-sm flex flex-col">
